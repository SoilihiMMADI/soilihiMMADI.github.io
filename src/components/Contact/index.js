            ...
            <div className="contact-part">
              <div className="part-1">
                <div className="text-zone">
                  <h1 className="text-center mb-4 title-contact">
                    ME CONTACTER
                  </h1>
                  <p className="text-contact">
                    Je suis actuellement à la recherche d'une entreprise pour
                    conclure mon année de Master 2. <br />
                    Si vous êtes intéressé par mon profil ou que vous connaissez
                    quelqu'un dans votre entourage qui le serait, n'héistez pas
                    à me contacter via se formulaire et à jetter un coup d'oeil
                    à mon Linkedin et mon GitHub{' '}
