            ...
            <div className="part-1">
              <div className="text-zone">
                ...
                <p className='text-contact'>
                  ...
                  conclure mon année de Master 2. <br />Si vous êtes intéressé par mon
                  profil ou que vous connaissez quelqu'un dans votre entourage
                  qui le serait, n'héistez pas à me contacter via se formulaire
                  et à jetter un coup d'oeil à mon LinkeDin et mon GitHub{' '}
